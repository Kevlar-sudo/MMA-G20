...
- *Gender score*: The same gender will produce a gender score of 0, and a different gender (M vs. F) will produce a gender score of 1. The gender score will be calculated based on the average outcome of what the user liked before, thus the closer to the previously average gender/sexual orientation will lead to a higher gender score. 
